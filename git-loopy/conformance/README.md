...
| `model-roster.json` | Canonical per-model `{efforts, tiers}` capability, generated from the Copilot CLI the pinned SDK spawns and stamped with its `cli_version`; its keys are the supported-model set (§14) |
