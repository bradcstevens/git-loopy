...
| `dashboard-insights.json` | Renderer-neutral Dashboard seam: normalized Event prefixes, injected clock/zone/config inputs, canonical Dashboard and drill-in inventory, Queue columns and scopes, placeholders, and expected semantic view models consumed by Python and future renderer #143 |
