...
| `model-roster.json` | Canonical `model → accepted reasoning-effort` sets; its keys are the supported-model set, stamped with the `cli_version` the content was captured against because effort capability is a function of Copilot CLI version (§14, ADR-0019) |
