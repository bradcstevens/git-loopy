...
including Static recovery without leaderboard access. This is the staged
Python-local guard, not final Dynamic-default activation. Shell/PowerShell
migration enforcement remains explicitly deferred; historical cases and Event
streams keep their original interpretation.
