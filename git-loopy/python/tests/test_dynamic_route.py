...
def test_unconfigured_support_preserves_the_published_reusable_input_identity():
    # The decision produced by main 3f5e7c4 before the supporting-source merge.
    assert _elected_decision().relevant_input_identity == (
        "98271cacc5998bbf986dfc3c2f88eb85cf059bbf8e73b302e238aa4c56ccbd6c"
    )
