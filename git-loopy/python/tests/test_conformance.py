...
def test_the_model_roster_fixture_names_the_harness_it_describes() -> None:
    """An SDK bump and its pinned-harness roster refresh are atomic (ADR-0019)."""
...
def test_the_roster_preserves_historical_gemini_efforts() -> None:
    """Preserve the historical Gemini rows, not new account-availability claims."""
