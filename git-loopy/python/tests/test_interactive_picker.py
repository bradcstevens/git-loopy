"""Tests for ``git_loopy.interactive.picker`` (issue #24 — picker orchestration).

:func:`~git_loopy.interactive.picker.resolve_run_model` is the seam the CLI calls
...
from git_loopy.interactive.picker import fetch_live_models, resolve_run_model
