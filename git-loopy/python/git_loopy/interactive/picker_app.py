"""``git_loopy.interactive.picker_app`` — the two-stage Textual picker (issue #24).
...
:mod:`git_loopy.interactive.models` and returns the operator's
:class:`~git_loopy.interactive.models.Selection` (or ``None`` if quit):
