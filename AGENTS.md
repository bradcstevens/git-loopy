...
labelled `wayfinder:map`, are planning documents, not executable tickets. Never apply
`ready-for-agent` to them; remove that label if present. Work their implementation
tickets instead.
