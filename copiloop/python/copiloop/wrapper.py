"""``copiloop.wrapper`` — wrapper contract logic, deep and pure.
...
#: writes ``Copiloop-Checkpoint: <ref>`` so a Checkpoint is distinguishable from an
...
CHECKPOINT_TRAILER_KEY = "Copiloop-Checkpoint"
