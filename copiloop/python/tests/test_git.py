"""Tests for ``copiloop.git`` (issue #6).
...
pytestmark = pytest.mark.skipif(
    ...
    reason="git not on PATH; copiloop.git wrappers cannot be exercised",
)
...
def test_commit_preserves_multi_paragraph_message(tmp_path: Path) -> None:
    ...
    assert "Copiloop-Checkpoint: 32" in recorded.body
