"""Tests for ``copiloop.interactive.picker`` (issue #24 — picker orchestration).

:func:`~copiloop.interactive.picker.resolve_run_model` is the seam the CLI calls
...
from copiloop.interactive.models import Selection
from copiloop.interactive.picker import fetch_live_models, resolve_run_model
