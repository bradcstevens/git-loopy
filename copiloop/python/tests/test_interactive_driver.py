"""Tests for ``copiloop.interactive.driver`` (issue #23 — peer orchestration).
...
from copiloop.interactive.driver import (
    InteractiveDriver,
...
class _FakeApp:
    """Stand-in for ``CopiloopApp``: ``run_async`` blocks until ``exit``."""
