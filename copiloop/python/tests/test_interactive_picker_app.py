"""Pilot tests for ``copiloop.interactive.picker_app`` (issue #24).
...
from copiloop.interactive.models import ModelChoice, Selection  # noqa: E402
from copiloop.interactive.picker_app import ModelPickerApp  # noqa: E402
