"""Tests for ``copiloop.session`` (issue #9).
...
from copiloop import session as session_module
...
from copiloop.ui import IterationSnapshot, Renderer, RunSummary  # noqa: F401
...
def test_session_module_imports_are_constrained() -> None:
    ...
    allow = {
        ...
        # peer copiloop modules — strictly the deep ones we integrate
