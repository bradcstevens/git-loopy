"""Unit tests for ``ralph_afk.worktree`` — the per-Lane worktree setup seam (#65).
...
from ralph_afk.worktree import (
...
def test_configured_command_takes_precedence_over_detected(
    ...
    """An explicit ``COPILOOP_WORKTREE_SETUP`` command wins over auto-detect."""
    setup = CommandWorktreeSetup(
